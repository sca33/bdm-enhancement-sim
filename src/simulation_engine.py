"""Shared simulation engine for all enhancement screens.

This module provides a unified simulation engine that is used by:
- SimulationScreen (animated simulation)
- HeptaOktaStrategyScreen (Monte Carlo analysis)
- RestorationStrategyScreen (Monte Carlo analysis)
"""
...
class EnhancementEngine:
    """Core simulation engine for BDM enhancement mechanics.
